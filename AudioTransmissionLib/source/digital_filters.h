...
namespace HoffFilters
{
  ...
  class FirPolyphaseBandpassFilter : FirBandPassFilter
  {
  public:
    FirPolyphaseBandpassFilter(double sample_rate, double pass_band_down, double stop_band_down, double pass_band_up, double stop_band_up, double absorbtion_in_stop_band, int decimation_factor);
    ~FirPolyphaseBandpassFilter();
    void CreatePolyphaseFilter(double* tmp_b_coefficients, int i);
    void InitPolyphaseFilters();
    void InitFilterOutpuTables();
    void InitDecimatorFilter();
